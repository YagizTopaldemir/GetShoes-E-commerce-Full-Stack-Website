            ...
            <div className='w-[100%]  xl:w-[45%] 2xl:w-[40%] xl:h-[100%] lg:h-[70%] md:h-[75%] h-[100%] flex justify-center items-center'>
                <div className='w-[90%] h-[100%] flex flex-col justify-center items-center'>
                    ...
                    <div className='w-[100%] h-[100%] flex flex-col justify-center items-center '>
                       ...
                       <p className="text-[2em] 3xl:text-[1.8em] 4xl:text-[2.5em]  font-semibold">GetShoes</p>
                    
                        <form className='w-[95%] md:w-[70%] xl:w-[80%] lg:w-[95%] 3xl:w-[75%] justify-center  flex gap-4 flex-col'>
                            ...
                            <div className='flex flex-row justify-between items-center'>
                                <div className='flex flex-row justify-start items-center gap-2'>
                                    <input type='checkbox' className='w-5 h-5 3xl:w-6 3xl:h-6 4xl:w-8 4xl:h-8 border-2 cursor-pointer border-[#2b2b2b4c] appearance-none bg-white  checked:bg-[#000] rounded-[0px] checked:rounded-[50%] duration-1000 transition-1' />
                                    <p className='font-medium 3xl:text-[1.18em]'>Remember me</p>
                                </div>
                                <div>
                                    <p className='font-medium text-md 4xl:text-[1.1em] cursor-pointer'>Forgot Password?</p>
                                </div>
                            </div>
                            ...
                            <p className='opacity-65 3xl:text-[1.3em] text-[1.2em]'>Dont have an account? <span className='text-green-500 cursor-pointer'><Link to="/signup">Sign Up</Link></span></p>
                        </div>
                        </form>
